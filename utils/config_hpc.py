...
ANNOTATIONS_DIRECTORY_PATH = f"{HOME}/dataset_hpc/train/labels"
IMAGES_DIRECTORY_PATH = f"{HOME}/dataset_hpc/train/images"
...
DATASET_DIR_PATH = f"{HOME}/dataset_hpc"
RESULTS_DIR_PATH = f"{HOME}/results_hpc"
# Plot sample images
SAMPLE_SIZE = 6
