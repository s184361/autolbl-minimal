...
def main():
    ...
    args.config = "D:/Data/dtu/OneDrive - Danmarks Tekniske Universitet/MSc MMC/5th semester/Thesis/autolbl/config.json"
    args.section = "local"
    # Load configuration
    ...
    try:
        ...
        print("No wandb")
    input_prompt = torch.tensor(base_model.grounding_dino_model.model.tokenizer("defect")["input_ids"], dtype=torch.float64,requires_grad=True)
    ont_input = base_model.grounding_dino_model.model.tokenizer.decode(input_prompt)
